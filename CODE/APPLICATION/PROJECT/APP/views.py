...
Model1 = joblib.load('C:/Users/User/Music/MAIN_PROJECT/CODE/APPLICATION/PROJECT/APP/GENERATION.pkl')
Model2 = joblib.load('C:/Users/User/Music/MAIN_PROJECT/CODE/APPLICATION/PROJECT/APP/RADIATION.pkl')    
...
def Deploy_9(request): 
    if request.method == "POST":
        ...
        output = prediction[0]
        print(output)        
        return render(request, '9_Deploy.html', {'prediction_text': f'THE SOLAR POWER MIGHT GENERATE {output} KW IN THIS CONDITIONS'})
    else:
...
def Deploy_10(request): 
    if request.method == "POST":
        ...
        output = prediction[0]
        print(output)        
        return render(request, '10_Deploy.html', {'prediction_text1': f'THE SOLAR RADIATION MIGHT COME {output} LEVEL IN THIS CONDITIONS'})
    else:
